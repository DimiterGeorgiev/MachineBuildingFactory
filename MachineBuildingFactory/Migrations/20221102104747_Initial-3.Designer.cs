...
namespace MachineBuildingFactory.Migrations
{
    ...
    [Migration("20221102104747_Initial-3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MachineBuildingFactory.Data.Models.Material", b =>
                {
                    ...
                    b.Property<string>("StandardOfMaterial")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("MachineBuildingFactory.Data.Models.Paint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MachineBuildingFactory.Data.Models.ProductionPart", b =>
                {
                    ...
                    b.HasOne("MachineBuildingFactory.Data.Models.Paint", "TypeOfPaint")
                        .WithMany()
                        .HasForeignKey("TypeOfPaintId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Material");

                    b.Navigation("TypeOfPaint");
                });
