    ...
    public partial class Initial1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssemblyProductionPart", x => new { x.AssemblyId, x.ProductionPartId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssemblyPurchasedPart", x => new { x.AssemblyId, x.PurchasedPartId });
                    table.ForeignKey(
