        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Signature = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectNummber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlAddress = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TypeOfProductionPart = table.Column<int>(type: "int", nullable: false),
                    ...
                    LaserCutLength = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchasedParts", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AssemblyId = table.Column<int>(type: "int", nullable: false),
                    PurchasedPartId = table.Column<int>(type: "int", nullable: false),
                    Quantaty = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssemblyPurchasedParts", x => new { x.AssemblyId, x.PurchasedPartId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchasedParts_SupplierId",
                table: "PurchasedParts",
                column: "SupplierId");
        }
